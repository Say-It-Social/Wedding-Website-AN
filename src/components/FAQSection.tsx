  ...
  return (
    <section className="section-container -py-[80px] md:12 bg-transparent ">
      <div className="text-center mb-16">
        <h2 className="font-display text-4xl md:text-6xl text-primary tracking-wide">
          FAQs
        </h2>
        ...
        {faqs.map((faq, index) => (
          ...
          >
            ...
            <div className="space-y-3">
              <h3 className="font-display text-base md:text-xl text-primary font-semibold">
                {faq.question}
              </h3>
              <div className="space-y-3">
                {faq.answer.map((paragraph, pIndex) => (
                  <p key={pIndex} className="font-serif text-sm md:text-base text-foreground leading-relaxed">
                    {paragraph}
                  </p>
                ))}
              </div>
