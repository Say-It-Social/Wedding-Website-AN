...
const events: WeddingEvent[] = [
  {
    ...
    additionalNote: "Colourful, and celebratory!\nDress like you want to steal the spotlight..",
    description: [],
    outfitImage: outfit1,
  },
  {
    ...
    additionalNote: "Comfort over fashion I would say. Tumeric has no mercy.",
    description: [],
    outfitImage: outfit2,
  },
  {
  ...
  },
  {
    ...
    dateImage: dateOct28,
    title: "Poolside Mela",
    subtitle: "Fun, comfortable outfits; you don't mind getting wet or messy.",
    description: [],
    outfitImage: outfit4,
  },
  {
            ...
            <div className="mx-auto md:max-w-5xl">
              ...
              >
                ...
                >
                  ...
                  {event.subtitle && (
                    <p className="font-serif text-sm md:text-lg text-muted-foreground italic">
                      {event.subtitle}
                    </p>
                  )}

                  {event.additionalNote && (
                    <p className="font-serif text-sm md:text-lg text-muted-foreground italic whitespace-pre-line">
                      {event.additionalNote}
                    </p>
                  )}
                ...
                >
                  <img
                    ...
                    className="h-28 w-auto max-w-[7rem] sm:h-36 sm:max-w-[9rem] md:h-80 md:max-w-[22rem] object-contain"
                  />
                </div>
              </div>
            </div>
