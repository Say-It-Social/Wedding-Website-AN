    ...
    <section className="py-16 bg-transparent">
      ...
      <div className="section-container pt-0 md:flex md:flex-col md:items-center">
        ...
        <div className="text-center mb-16 md:mb-12 max-w-2xl mx-auto">
          <p className="font-serif text-sm md:text-lg text-muted-foreground leading-relaxed">
            ...
            >
              <div className="md:grid md:grid-cols-2 md:gap-8 md:max-w-4xl md:mx-auto md:items-center">
                ...
                <div className="flex items-center gap-4 md:block">
                  ...
                  <h3 className="font-display text-base font-semibold text-primary md:hidden">
                    {destination.title}
                  </h3>
                </div>
                ...
                <div className="mt-4 md:mt-0 flex flex-col space-y-2 md:space-y-3">
                  ...
                  {/* October Content */}
                  <div className="pt-1">
                    <p className="font-serif text-xs md:text-sm text-muted-foreground italic mb-1">
                      {destination.octoberTitle}
                    </p>
                    <ul className="list-disc list-inside font-serif text-xs md:text-sm text-muted-foreground space-y-1">
