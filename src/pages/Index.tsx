              ...
              >
                ...
                >
                 <div className="md:-mt-48">
                  ...
                  {/* DATE — banner shifted slightly left to align golden line with logo & Ganesh */}
                  <section className="text-center px-4 md:px-8 py-6">
                    <div className="flex justify-center gap-4 md:gap-16 -ml-5 md:-ml-7">
                  ...
                  {/* INTRO — less padding on mobile so text has more room */}
                  <section className="px-4 sm:px-5 md:px-12 pb-6 text-center">
