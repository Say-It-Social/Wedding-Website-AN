      ...
      <MobilePageWrapper>
        ...
        >
          ...
          <section className="text-center px-4 md:px-8 py-6 -mt-2 mb-6 md:mb-4">
            <h1 className="font-cormorant text-5xl sm:text-6xl md:text-[145px] text-primary tracking-[0.1em] mb-2 font-semibold">
                  R.S.V.P
                </h1>
            <div className="mt-2 flex flex-wrap items-center justify-center gap-2 md:gap-4">
              <p className="font-lora text-sm text-primary text-center">
                Please respond before March 31<sup>st</sup>, 2026.
              </p>
              <CountdownTimer
                className="w-auto px-0 py-0"
                innerClassName="w-auto max-w-none mx-0"
              />
            </div>
          </section>

          {/* Form Card */}
          <div className="px-4 md:px-8 pb-8 md:mt-12">
