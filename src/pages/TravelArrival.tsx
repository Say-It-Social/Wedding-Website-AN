  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="min-h-screen flex flex-col items-center py-4 px-4 md:px-8">
        {/* Main Card Container */}
        <motion.div
          className="w-[90%] max-w-md mx-auto rounded-t-[150px] overflow-hidden md:overflow-visible md:w-full md:max-w-none md:rounded-none md:mt-0 md:pt-10 md:clip-none"
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          style={{
